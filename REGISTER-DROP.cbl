      ...
      *-----------------------------------------------------------------
       ...
       COPY SCR-COMMON.
       01  SCRN-TITLE.
           03  LINE 3  COL 34  VALUE 'REGISTER DROP CLASSES'.
       01  SCRN-DATA.
           03  SCRN-STU-ID.
           ...
           03  SCRN-YEAR-SEM.
               ...
               05          COL 66  PIC Z9   TO REG-SEM
                                            AUTO REQUIRED. 
       01  SCRN-CRSE.    
           03  SCRN-FIRST-CRSE.
               05  LINE 11  COL 24  VALUE   '1) FIRST COURSE : '.
               05           COL 42  PIC X(39) FROM WS-CRSE-NAME.
           03  SCRN-SECOND-CRSE.
               05  LINE 12 COL 24  VALUE   '2) SECOND COURSE: '.
               05          COL 42  PIC X(39) FROM WS-CRSE-NAME.
           03  SCRN-THIRD-CRSE.
               05  LINE 13 COL 24  VALUE   '3) THIRD COURSE : '.
               05          COL 42  PIC X(39) FROM WS-CRSE-NAME.
           03  SCRN-FOURTH-CRSE.
               05  LINE 14 COL 24  VALUE   '4) FOURTH COURSE: '.
               05          COL 42  PIC X(39) FROM WS-CRSE-NAME.
           03  SCRN-FIFTH-CRSE.
               05  LINE 15 COL 24  VALUE   '5) FIFTH COURSE : '.
               05          COL 42  PIC X(39) FROM WS-CRSE-NAME.
           03  SCRN-RETURN.
               05  LINE 16 COL 24  VALUE   'R) FINISH'.
           03  SCRN-SEL.
               05  LINE 18  COL 40  VALUE     'SELECTION'.
               05           COL 38  PIC X     TO WS-RESP.
       01  SCRN-ERR1.
